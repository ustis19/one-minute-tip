...
function Card({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return <div className={`rounded-xl border bg-white dark:bg-gray-800 p-4 shadow ${className}`}>{children}</div>;
}
...
function AdBlock() {
  return (
    <div className="max-w-xl my-8 p-4 border rounded bg-yellow-50 dark:bg-yellow-100 text-center text-yellow-800 shadow-md">
...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 p-6 relative">
        <Image
          src="/bg-nature-light.jpg"
          alt="background"
          layout="fill"
          objectFit="cover"
        ...
        <header className="mb-10 text-center">
          ...
          <nav className="flex justify-center gap-4 text-blue-600 underline dark:text-blue-400">
